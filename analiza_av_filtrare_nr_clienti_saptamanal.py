...
total_clienti = clienti_zile_lucr + clienti_weekend
...
if clienti_duminica > clienti_sambata:
    print("Duminica a fost o zi de vanzari mai buna decat sambata.")
elif clienti_sambata == clienti_duminica:
    print("Sambata si duminica au avut acelasi numar de clienti.")
else:
    print("Sambata a fost o zi de vanzari mai buna decat duminica.")
